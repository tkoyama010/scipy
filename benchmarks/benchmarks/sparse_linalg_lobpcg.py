...
def _sakurai(n):
    ...
    k = arange(1, n + 1)
    w_ex = sort(1.0 / (16.0 * pow(cos(0.5 * k * pi / (n + 1)), 4)))  # exact eigenvalues
...
class Bench(Benchmark):
    ...
    def time_sakurai(self, n, solver):
        ...
        if solver == "lobpcg":
            X = rand(n, m)
            eigs, vecs, resnh = lobpcg(
                self.A, X, self.B, tol=1e-6, maxiter=500, retResidualNormsHistory=1
            )
        else:
    ...
    time_mikota.version = (
        "a1fb679758f7e5cf79d18cc4930afdff999fccc142fe7a4f63e73b39ab1f58bb"
    )
    time_sakurai.version = (
        "7c38d449924fb71f777bd408072ecc883b8b05e53a6544e97da3887fbc10b235"
    )
