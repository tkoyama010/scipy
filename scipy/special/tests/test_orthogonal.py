...
class TestGegenbauer(object):
    def test_gegenbauer(self):
        ...
        assert_array_almost_equal(
            Ca3.c, array([4 * orth.poch(a, 3), 0, -6 * a * (a + 1), 0]) / 3.0, 11
        )
        assert_array_almost_equal(
            Ca4.c,
            array([4 * orth.poch(a, 4), 0, -12 * orth.poch(a, 3), 0, 3 * a * (a + 1)])
            / 6.0,
            11,
        )
        assert_array_almost_equal(
...
def test_roots_gegenbauer():
    ...
    vgq(rootf(0), orth.eval_chebyt, weightf(0), -1.0, 1.0, 5)
    vgq(rootf(0), orth.eval_chebyt, weightf(0), -1.0, 1.0, 25)
    vgq(rootf(0), orth.eval_chebyt, weightf(0), -1.0, 1.0, 100, atol=1e-12)
...
def test_roots_chebyt():
    ...
    verify_gauss_quad(sc.roots_chebyt, orth.eval_chebyt, weightf, -1.0, 1.0, 5)
    verify_gauss_quad(sc.roots_chebyt, orth.eval_chebyt, weightf, -1.0, 1.0, 25)
    verify_gauss_quad(
        sc.roots_chebyt, orth.eval_chebyt, weightf, -1.0, 1.0, 100, atol=1e-12
    )
...
def test_roots_chebyu():
    ...
    verify_gauss_quad(sc.roots_chebyu, orth.eval_chebyu, weightf, -1.0, 1.0, 5)
    verify_gauss_quad(sc.roots_chebyu, orth.eval_chebyu, weightf, -1.0, 1.0, 25)
    verify_gauss_quad(sc.roots_chebyu, orth.eval_chebyu, weightf, -1.0, 1.0, 100)
...
def test_roots_chebyc():
    ...
    verify_gauss_quad(sc.roots_chebyc, orth.eval_chebyc, weightf, -2.0, 2.0, 5)
    verify_gauss_quad(sc.roots_chebyc, orth.eval_chebyc, weightf, -2.0, 2.0, 25)
    verify_gauss_quad(
        sc.roots_chebyc, orth.eval_chebyc, weightf, -2.0, 2.0, 100, atol=1e-12
    )
...
def test_roots_chebys():
    ...
    verify_gauss_quad(sc.roots_chebys, orth.eval_chebys, weightf, -2.0, 2.0, 5)
    verify_gauss_quad(sc.roots_chebys, orth.eval_chebys, weightf, -2.0, 2.0, 25)
    verify_gauss_quad(sc.roots_chebys, orth.eval_chebys, weightf, -2.0, 2.0, 100)
...
def test_roots_sh_chebyt():
    ...
    verify_gauss_quad(sc.roots_sh_chebyt, orth.eval_sh_chebyt, weightf, 0.0, 1.0, 5)
    verify_gauss_quad(sc.roots_sh_chebyt, orth.eval_sh_chebyt, weightf, 0.0, 1.0, 25)
    verify_gauss_quad(
        sc.roots_sh_chebyt, orth.eval_sh_chebyt, weightf, 0.0, 1.0, 100, atol=1e-13
    )
...
def test_roots_sh_chebyu():
    ...
    verify_gauss_quad(sc.roots_sh_chebyu, orth.eval_sh_chebyu, weightf, 0.0, 1.0, 5)
    verify_gauss_quad(sc.roots_sh_chebyu, orth.eval_sh_chebyu, weightf, 0.0, 1.0, 25)
    verify_gauss_quad(
        sc.roots_sh_chebyu, orth.eval_sh_chebyu, weightf, 0.0, 1.0, 100, atol=1e-13
    )
...
def test_roots_legendre():
    ...
    verify_gauss_quad(sc.roots_legendre, orth.eval_legendre, weightf, -1.0, 1.0, 5)
    verify_gauss_quad(
        sc.roots_legendre, orth.eval_legendre, weightf, -1.0, 1.0, 25, atol=1e-13
    )
    verify_gauss_quad(
        sc.roots_legendre, orth.eval_legendre, weightf, -1.0, 1.0, 100, atol=1e-12
    )
...
def test_roots_sh_legendre():
    ...
    verify_gauss_quad(sc.roots_sh_legendre, orth.eval_sh_legendre, weightf, 0.0, 1.0, 5)
    verify_gauss_quad(
        sc.roots_sh_legendre, orth.eval_sh_legendre, weightf, 0.0, 1.0, 25, atol=1e-13
    )
    verify_gauss_quad(
        sc.roots_sh_legendre, orth.eval_sh_legendre, weightf, 0.0, 1.0, 100, atol=1e-12
    )
...
def test_roots_laguerre():
    ...
    verify_gauss_quad(sc.roots_laguerre, orth.eval_laguerre, weightf, 0.0, np.inf, 5)
    verify_gauss_quad(
        sc.roots_laguerre, orth.eval_laguerre, weightf, 0.0, np.inf, 25, atol=1e-13
    )
    verify_gauss_quad(
        sc.roots_laguerre, orth.eval_laguerre, weightf, 0.0, np.inf, 100, atol=1e-12
    )
