...
class TestFFT1D(object):
    ...
    def test_fft(self):
        ...
        assert_array_almost_equal(fft1(x) / np.sqrt(30), fft.fft(x, norm="ortho"))

    def test_ifft(self):
        x = random(30) + 1j * random(30)
        assert_array_almost_equal(x, fft.ifft(fft.fft(x)))
        assert_array_almost_equal(x, fft.ifft(fft.fft(x, norm="ortho"), norm="ortho"))

    def test_fft2(self):
        x = random((30, 20)) + 1j * random((30, 20))
        assert_array_almost_equal(fft.fft(fft.fft(x, axis=1), axis=0), fft.fft2(x))
        assert_array_almost_equal(
            fft.fft2(x) / np.sqrt(30 * 20), fft.fft2(x, norm="ortho")
        )

    def test_ifft2(self):
        x = random((30, 20)) + 1j * random((30, 20))
        assert_array_almost_equal(fft.ifft(fft.ifft(x, axis=1), axis=0), fft.ifft2(x))
        assert_array_almost_equal(
            fft.ifft2(x) * np.sqrt(30 * 20), fft.ifft2(x, norm="ortho")
        )

    def test_fftn(self):
        x = random((30, 20, 10)) + 1j * random((30, 20, 10))
        assert_array_almost_equal(
            fft.fft(fft.fft(fft.fft(x, axis=2), axis=1), axis=0), fft.fftn(x)
        )
        assert_array_almost_equal(
            fft.fftn(x) / np.sqrt(30 * 20 * 10), fft.fftn(x, norm="ortho")
        )

    def test_ifftn(self):
        x = random((30, 20, 10)) + 1j * random((30, 20, 10))
        assert_array_almost_equal(
            fft.ifft(fft.ifft(fft.ifft(x, axis=2), axis=1), axis=0), fft.ifftn(x)
        )
        assert_array_almost_equal(
    ...
    def test_irfft(self):
        ...
        assert_array_almost_equal(x, fft.irfft(fft.rfft(x, norm="ortho"), norm="ortho"))

    def test_rfft2(self):
        x = random((30, 20))
        assert_array_almost_equal(fft.fft2(x)[:, :11], fft.rfft2(x))
        assert_array_almost_equal(
            fft.rfft2(x) / np.sqrt(30 * 20), fft.rfft2(x, norm="ortho")
        )
    ...
    def test_rfftn(self):
        ...
        assert_array_almost_equal(
            fft.rfftn(x) / np.sqrt(30 * 20 * 10), fft.rfftn(x, norm="ortho")
        )
    ...
    def test_hfft(self):
        ...
        assert_array_almost_equal(
            fft.hfft(x_herm) / np.sqrt(30), fft.hfft(x_herm, norm="ortho")
        )
    ...
    def test_ihfft(self):
        ...
        assert_array_almost_equal(
            x_herm, fft.ihfft(fft.hfft(x_herm, norm="ortho"), norm="ortho")
        )
    ...
    def test_ihfft2(self):
        ...
        assert_array_almost_equal(
            fft.ihfft2(x) * np.sqrt(30 * 20), fft.ihfft2(x, norm="ortho")
        )
    ...
    def test_ihfftn(self):
        ...
        assert_array_almost_equal(
            fft.ihfftn(x) * np.sqrt(30 * 20 * 10), fft.ihfftn(x, norm="ortho")
        )
