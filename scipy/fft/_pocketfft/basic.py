...
def c2c(forward, x, n=None, axis=-1, norm=None, overwrite_x=False, workers=None):
...
def r2c(forward, x, n=None, axis=-1, norm=None, overwrite_x=False, workers=None):
    """
...
def c2r(forward, x, n=None, axis=-1, norm=None, overwrite_x=False, workers=None):
    """
